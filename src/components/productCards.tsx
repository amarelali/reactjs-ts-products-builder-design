  ...
  return (
    <div className="max-w-sm border rounded-md p-2 flex flex-col">
      ...
      <div className="flex items-center justify-between space-x-2 my-5">
        <Button className="bg-indigo-700" onClick={()=>{console.log("click")}} width="w-full">Edit</Button>
        <Button className="bg-red-700" onBlur={()=>{console.log("blur")}} width="w-full">Delete</Button>
